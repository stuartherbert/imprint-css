...
There isn't much to say about lists. ImprintCSS provides very straight-forward styling for both bullet-point lists (unordered lists) and indexed lists (ordered lists).
