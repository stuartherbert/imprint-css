...
Imprint CSS includes over 1,500 named colors that you can use in Tailwind CSS v3 or import directly into your Javascript and Typescript projects. There's a dedicated page for each color collection (such as <InternalLink slug="colors/imprint-css-collection"/>), and a dedicated page for each individual color (such as <ColorLink colorName="imprint-blackgold"/>).
